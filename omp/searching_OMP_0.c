...
////////////////////////////////////////////////////////////////////////////////
// searching_OMP_0 - Basic Parallel Implementation using OpenMP
////////////////////////////////////////////////////////////////////////////////

/*searching_OMP_0.c
Description:
  The purpose of this program is to create a basic parallel implementation of a sequential
  searching program using the OpenMP API.
*/
...
int hostMatch(long *comparisons)
{
    ...
    */
    #pragma omp parallel shared(found, comparisons_temp) private(j, k)      \
...

    {
        ...
        */
        ...
        #pragma omp for reduction(+:comparisons_temp) schedule(dynamic)

        //iterating through all of text data
        for(i = 0; i<= lastI; i++)
            ...
            if(i < found)
             {
                ...
                //while pattern is in the text and pattern has not searched through
        ...
        //race condition on comparions variable so it is set outside the parallel loop
        *comparisons = comparisons_temp;
