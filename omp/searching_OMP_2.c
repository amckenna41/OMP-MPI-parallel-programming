...
////////////////////////////////////////////////////////////////////////////////
// searching_OMP_2 - Optimised and improved Parallel Implementation using OpenMP
////////////////////////////////////////////////////////////////////////////////

/*searching_OMP_1.c
Description:
  The purpose of this program is to improve upon the searching_OMP_1.c program, improving its performance,
  speed and accuracy. This is achieved by optimising the pattern search algorithm using OpenMP constructs,
  so that the number of comparisons made by the algorithm is reduced.
*/
        ...
        */
        #pragma omp parallel shared(found, comparisons)           \
                           ...
                           firstprivate(lastI, textData, patternData, patternLength)
         {
            ...
            //iterating through text until end
            for(i = 0; i<= lastI; i++)
